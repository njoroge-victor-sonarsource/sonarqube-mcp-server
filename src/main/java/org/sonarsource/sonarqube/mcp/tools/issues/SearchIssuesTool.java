...
public class SearchIssuesTool extends Tool {
  ...
  private static McpSchema.Tool createToolDefinition(boolean isSonarQubeCloud) {
    ...
    return SchemaToolBuilder.forOutput(SearchIssuesToolResponse.class)
      ...
      .addStringArrayProperty(PROJECTS_PROPERTY, "An optional list of Sonar projects to look in")
      .addStringArrayProperty(FILES_PROPERTY, "An optional list of component keys (files, directories, modules) to filter issues")
      ...
      .addStringArrayProperty(ISSUE_KEY_PROPERTY, "An optional list of issue keys to fetch specific issues")
